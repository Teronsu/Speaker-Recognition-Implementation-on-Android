    ...
    private final class RecognizerThread extends Thread {
        ...
        public void run() {
            ...
            while (!interrupted()
                ...
                long elapsedSeconds = (System.currentTimeMillis() - lastTimestamp) / 1000;
                if (recognizer.acceptWaveForm(buffer, nread) || elapsedSeconds >= 3) {
                    ...
                    if (result.contains("\"spk\"")) {
                        ...
                        mainHandler.post(() -> listener.onResult(tempstring));
                    }
